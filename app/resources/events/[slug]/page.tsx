    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <Button asChild variant="outline" className="mb-8 bg-accent/20 text-accent border border-accent/30 hover:bg-accent/30">
              <Link href="/resources/events">
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back to Events
              </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-primary/10 p-6 rounded-lg">
                ...
                <Button asChild className="w-full bg-primary/20 text-primary border border-primary/30 hover:bg-primary/30">
                  <Link href="/contact">
                    Contact Us
                  </Link>
                </Button>
